          ...
          <div className="container mx-auto px-4 text-center">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-soft max-w-md mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Maaf, artikel yang Anda cari tidak tersedia. Silakan kembali ke
                halaman blog.
              </p>
              <Button
              ...
              <div className="p-6 md:p-8">
                <div className="flex flex-wrap items-center gap-4 mb-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span
                      className={`px-3 py-1 ${getCategoryBadgeClass()} text-xs font-medium rounded-full`}
                    >
                      {post.category}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-2">
                      <Button
                        ...
                        onClick={() => {
                          window.open(
                            `https://x.com/intent/post?text=${encodeURIComponent(post.title)}&url=${encodeURIComponent(window.location.href)}`,
                            "_blank",
                          );
                        }}
                      >
